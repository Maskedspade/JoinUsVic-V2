    ...
    return (
      ...
      >
        ...
        <Modal.Content image>
          ...
          Hey! It's Lindsey and Yuhan! Great to see you here 😃. <br/>We just wanted to let you know that this 3D model of Victoria is by no means the latest update or the most precise, but it is certainly a master piece by Yuhan during her architecture studies.
          <br/>We made this web app to showcase some of the fun places to do fun things, coming from us - the two people that don't go out all that much 🤯.
